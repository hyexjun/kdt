class Book :
    book_list0 = [["[제목]Cooking Light      ", "[분류]living, cooking", 15000, "[비고]America Cooking"],
                  ["[제목]Auto Bild          ", "[분류]science, car   ", 16000, "[비고]Germany Car    "],
                  ["[제목]The Confession     ", "[저자]Grisham, John  ", 10500, "                     "],
                  ["[제목]Les Miserables     ", "[저자]Hugo, Victor   ", 17500, "                     "],
                  ["[제목]Breakthrough       ", "[저자]Ifill, Gwen    ", 47200, "                     "],
